...
export default function MonitorPage() {
  ...
  return (
    <AnimatedPage className={isMobile ? "px-2 py-4" : "px-3 lg:px-6 py-8"}>
      <div className="mb-6 space-y-3">
          ...
          <div className="min-w-0">
            ...
            <div
              className={`text-xs text-default-500 ${
                isMobile ? "leading-5 whitespace-normal" : "truncate"
              }`}
            >
        ...
        {/* Tab Switcher */}
        <div
          className={`flex items-center gap-1 p-1 rounded-xl bg-default-100 dark:bg-default-50/10 ${
      ...
      {activeTab === "nodes" ? (
        <MonitorView nodeMap={nodeMap} viewMode={effectiveViewMode} />
      ) : (
        <TunnelMonitorView viewMode={effectiveViewMode} />
      )}
    </AnimatedPage>
  );
}
