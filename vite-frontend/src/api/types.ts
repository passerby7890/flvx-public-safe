...
export interface TunnelCoverProfileApiItem {
  id?: number;
  tunnelId: number;
  enabled: number;
  siteLabel?: string;
...
export interface CoverDomainProfileApiItem {
  id?: number;
  name: string;
  enabled: number;
  siteLabel?: string;
...
export interface TunnelCoverSelectionApiItem {
  tunnelId: number;
  profileIds: number[];
  [key: string]: unknown;
}

export interface NodeCoverServiceApiItem {
  id?: number;
  nodeId: number;
  enabled: number;
  publicPort: number;
...
export interface ForwardBatchJobApiData {
  jobId: string;
  action: string;
...
export interface AsyncJobApiData extends ForwardBatchJobApiData {}

export interface ForwardEntryStatusSummaryApiItem {
  forwardId: number;
  forwardName: string;
  total: number;
  healthy: number;
...
export interface ForwardTargetStatusSummaryApiItem {
  forwardId: number;
  forwardName: string;
  total: number;
  healthy: number;
...
export interface ForwardSLAStatusSummaryApiItem {
  forwardId: number;
  forwardName: string;
  userId: number;
  tunnelId: number;
  mode: "direct" | "sni";
  overallStatus: "healthy" | "partial" | "failed" | "unknown";
  entryStatus: "healthy" | "partial" | "failed" | "unknown";
  targetStatus: "healthy" | "partial" | "failed" | "unknown";
  entryTotal: number;
  entryHealthy: number;
  targetTotal: number;
