...
type Forward struct {
	...
	Mode        string        `gorm:"column:mode;type:varchar(20);not null;default:'direct'"`
	RemoteAddr  string        `gorm:"column:remote_addr;type:text;not null"`
	SniRules    string        `gorm:"column:sni_rules;type:text;not null;default:''"`
...
type TunnelCoverProfile struct {
	ID              int64  `gorm:"primaryKey;autoIncrement" json:"id"`
	TunnelID        int64  `gorm:"column:tunnel_id;not null;uniqueIndex" json:"tunnelId"`
	Enabled         int    `gorm:"not null;default:0" json:"enabled"`
	SiteLabel       string `gorm:"column:site_label;type:text;not null;default:''" json:"siteLabel"`
	Domains         string `gorm:"type:text;not null;default:''" json:"domains"`
	CertProfile     string `gorm:"column:cert_profile;type:text;not null;default:''" json:"certProfile"`
	DNSProvider     string `gorm:"column:dns_provider;type:text;not null;default:''" json:"dnsProvider"`
	DNSProfile      string `gorm:"column:dns_profile;type:text;not null;default:''" json:"dnsProfile"`
	TemplateProfile string `gorm:"column:template_profile;type:text;not null;default:'static'" json:"templateProfile"`
	UpstreamOrigin  string `gorm:"column:upstream_origin;type:text;not null;default:''" json:"upstreamOrigin"`
	StaticHTML      string `gorm:"column:static_html;type:text;not null;default:''" json:"staticHtml"`
	CreatedTime     int64  `gorm:"column:created_time;not null" json:"createdTime"`
	UpdatedTime     int64  `gorm:"column:updated_time;not null" json:"updatedTime"`
}

func (TunnelCoverProfile) TableName() string { return "tunnel_cover_profile" }

type CoverDomainProfile struct {
	ID              int64  `gorm:"primaryKey;autoIncrement" json:"id"`
	Name            string `gorm:"type:text;not null;uniqueIndex:idx_cover_domain_profile_name" json:"name"`
	Enabled         int    `gorm:"not null;default:1" json:"enabled"`
	SiteLabel       string `gorm:"column:site_label;type:text;not null;default:''" json:"siteLabel"`
	Domains         string `gorm:"type:text;not null;default:''" json:"domains"`
	CertProfile     string `gorm:"column:cert_profile;type:text;not null;default:''" json:"certProfile"`
...
func (CoverDomainProfile) TableName() string { return "cover_domain_profile" }

type TunnelCoverBinding struct {
	ID          int64 `gorm:"primaryKey;autoIncrement" json:"id"`
	TunnelID    int64 `gorm:"column:tunnel_id;not null;uniqueIndex:idx_tunnel_cover_binding_unique;index:idx_tunnel_cover_binding_tunnel" json:"tunnelId"`
	ProfileID   int64 `gorm:"column:profile_id;not null;uniqueIndex:idx_tunnel_cover_binding_unique;index:idx_tunnel_cover_binding_profile" json:"profileId"`
	Enabled     int   `gorm:"not null;default:1" json:"enabled"`
	CreatedTime int64 `gorm:"column:created_time;not null" json:"createdTime"`
	UpdatedTime int64 `gorm:"column:updated_time;not null" json:"updatedTime"`
}

func (TunnelCoverBinding) TableName() string { return "tunnel_cover_binding" }

type NodeCoverService struct {
	ID           int64  `gorm:"primaryKey;autoIncrement" json:"id"`
	NodeID       int64  `gorm:"column:node_id;not null;uniqueIndex" json:"nodeId"`
	Enabled      int    `gorm:"not null;default:0" json:"enabled"`
	PublicPort   int    `gorm:"column:public_port;not null;default:443" json:"publicPort"`
	LocalListen  string `gorm:"column:local_listen;type:text;not null;default:'127.0.0.1:10443'" json:"localListen"`
	LastSyncTime int64  `gorm:"column:last_sync_time;not null;default:0" json:"lastSyncTime"`
	LastStatus   string `gorm:"column:last_status;type:text;not null;default:''" json:"lastStatus"`
	CreatedTime  int64  `gorm:"column:created_time;not null" json:"createdTime"`
	UpdatedTime  int64  `gorm:"column:updated_time;not null" json:"updatedTime"`
}

func (NodeCoverService) TableName() string { return "node_cover_service" }
...
type ForwardBackup struct {
	...
	SniRules     string               `json:"sniRules,omitempty"`
...
type ForwardSLAState struct {
	ForwardID           int64   `gorm:"column:forward_id;primaryKey" json:"forwardId"`
	ForwardName         string  `gorm:"column:forward_name;type:varchar(100);not null" json:"forwardName"`
	...
	OverallStatus       string  `gorm:"column:overall_status;type:varchar(20);not null;index" json:"overallStatus"`
	EntryStatus         string  `gorm:"column:entry_status;type:varchar(20);not null" json:"entryStatus"`
	TargetStatus        string  `gorm:"column:target_status;type:varchar(20);not null" json:"targetStatus"`
	EntryTotal          int     `gorm:"column:entry_total;not null;default:0" json:"entryTotal"`
	EntryHealthy        int     `gorm:"column:entry_healthy;not null;default:0" json:"entryHealthy"`
	TargetTotal         int     `gorm:"column:target_total;not null;default:0" json:"targetTotal"`
	TargetHealthy       int     `gorm:"column:target_healthy;not null;default:0" json:"targetHealthy"`
	EntryCheckedAt      int64   `gorm:"column:entry_checked_at;not null;default:0" json:"entryCheckedAt"`
	TargetCheckedAt     int64   `gorm:"column:target_checked_at;not null;default:0" json:"targetCheckedAt"`
	CheckedAt           int64   `gorm:"column:checked_at;not null;index" json:"checkedAt"`
	Uptime24h           float64 `gorm:"column:uptime_24h;not null;default:0" json:"uptime24h"`
	Samples24h          int     `gorm:"column:samples_24h;not null;default:0" json:"samples24h"`
	ConsecutiveFailures int     `gorm:"column:consecutive_failures;not null;default:0" json:"consecutiveFailures"`
	FirstFailureAt      int64   `gorm:"column:first_failure_at;not null;default:0" json:"firstFailureAt"`
	LastFailureAt       int64   `gorm:"column:last_failure_at;not null;default:0" json:"lastFailureAt"`
	LastHealthyAt       int64   `gorm:"column:last_healthy_at;not null;default:0" json:"lastHealthyAt"`
	FailureKind         string  `gorm:"column:failure_kind;type:varchar(40);not null;default:''" json:"failureKind"`
	Reason              string  `gorm:"type:text;not null;default:''" json:"reason"`
	CreatedTime         int64   `gorm:"column:created_time;not null" json:"createdTime"`
	UpdatedTime         int64   `gorm:"column:updated_time;not null" json:"updatedTime"`
}

func (ForwardSLAState) TableName() string { return "forward_sla_state" }

type ForwardSLASnapshot struct {
	ID              int64  `gorm:"primaryKey;autoIncrement" json:"id"`
	ForwardID       int64  `gorm:"column:forward_id;not null;index:idx_forward_sla_forward_time,priority:1" json:"forwardId"`
	ForwardName     string `gorm:"column:forward_name;type:varchar(100);not null" json:"forwardName"`
	UserID          int64  `gorm:"column:user_id;not null;index" json:"userId"`
	TunnelID        int64  `gorm:"column:tunnel_id;not null;index" json:"tunnelId"`
	Mode            string `gorm:"type:varchar(20);not null" json:"mode"`
	...
	EntryCheckedAt  int64  `gorm:"column:entry_checked_at;not null;default:0" json:"entryCheckedAt"`
	TargetCheckedAt int64  `gorm:"column:target_checked_at;not null;default:0" json:"targetCheckedAt"`
	Timestamp       int64  `gorm:"not null;index:idx_forward_sla_forward_time,priority:2;index:idx_forward_sla_time" json:"timestamp"`
}

func (ForwardSLASnapshot) TableName() string { return "forward_sla_snapshot" }
