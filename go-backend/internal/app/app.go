...
func New(cfg config.Config) (*App, error) {
	...
	s := &http.Server{
		...
		// Mutations may synchronously fan out runtime updates to many nodes and
		// many forward rules. Keep the server-side request budget comfortably
		// above the frontend/API proxy timeout to avoid premature disconnects.
